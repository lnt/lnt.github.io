<div id="footer" role="contentinfo">
    <ul id="footer-info">
        <li id="footer-info-lastmod"> This page was last modified on 23 October 2016, at 10:22.</li>
        <li id="footer-info-copyright">Text is available under the <a rel="license"
            ...
            additional terms may apply. By using this site, you agree to the <a
                    ...
                    href="https://wikimediafoundation.org/wiki/Privacy_policy">Privacy Policy</a>. Wikipedia® is a
            registered trademark of the <a href="https://www.wikimediafoundation.org/">Wikimedia Foundation, Inc.</a>, a
            non-profit organization.
        </li>
    </ul>
    <ul id="footer-places">
        <li id="footer-places-privacy"><a href="https://wikimediafoundation.org/wiki/Privacy_policy" class="extiw"
                                          title="wmf:Privacy policy">Privacy policy</a></li>
        <li id="footer-places-about"><a href="https://en.wikipedia.org/wiki/Wikipedia:About" title="Wikipedia:About">About
                Wikipedia</a></li>
        <li id="footer-places-disclaimer"><a href="https://en.wikipedia.org/wiki/Wikipedia:General_disclaimer"
                                             title="Wikipedia:General disclaimer">Disclaimers</a></li>
        <li id="footer-places-contact"><a href="https://en.wikipedia.org/wiki/Wikipedia:Contact_us">Contact
                Wikipedia</a></li>
    ...
    <ul id="footer-icons" class="noprint">
        <li id="footer-copyrightico">
            <a href="https://wikimediafoundation.org/"><img src="./w/wikimedia-button.png"
                                                            srcset="/static/images/wikimedia-button-1.5x.png 1.5x, /static/images/wikimedia-button-2x.png 2x"
                                                            width="88" height="31" alt="Wikimedia Foundation"></a></li>
        <li id="footer-poweredbyico">
            <a href="https://www.mediawiki.org/"><img src="./w/poweredby_mediawiki_88x31.png" alt="Powered by MediaWiki"
...
{literal}
            ...
            mw.config.set({
                "wgPageParseReport": {
                    "limitreport": {
                        ...
                        "timingprofile": [
                            "100.00%  408.450      1 -total",
                            " 35.09%  143.326      1 Template:Reflist",
                            " 23.98%   97.950      1 Template:Infobox_person",
                            " 23.76%   97.028     25 Template:Cite_web",
                            " 15.87%   64.825      1 Template:Infobox",
                            " 14.02%   57.253      1 Template:Pp-blp",
                            "  8.48%   34.650      2 Template:Navbox",
                            "  8.27%   33.795      1 Template:Microsoft_Executives",
                            "  5.19%   21.200      5 Template:Br_separated_entries",
                            "  3.87%   15.826      1 Template:Wikidata_image"
                        ]
                    },
                    "scribunto": {
    ...
    <script>(window.RLQ = window.RLQ || []).push(function() {
            mw.config.set({"wgBackendResponseTime": 555, "wgHostname": "mw1268"});
        });</script>
{/literal}
